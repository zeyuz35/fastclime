...
# Implement the exact user CVXR function for comparison
...
Omega_fastclime <- QLASSO.Hessian.Omega.BK17.CLIME(X, lambda_1=0.5, lambda_2=1.0)$Omega
Omega_cvxr <- QLASSO.Hessian.Omega.BK17.CLIME.CVXR(X, lambda_1=0.5, lambda_2=1.0)

print(Omega_fastclime)
print(Omega_cvxr)

# Compare them
diff <- max(abs(Omega_fastclime - Omega_cvxr))
