...
#'
#' Print the information about the sample size, the dimension, the graph type
#' and sparsity of the true graph structure.
#'
...
#'
#' Visualize the covariance matrix, the empirical covariance matrix, the
#' adjacency matrix and the graph pattern of the true graph structure.
#'
#' @param x An object with S3 class \code{"sim"}.
#' @param ... System reserved (no specific usage).
#' @seealso \code{\link{fastclime.generator}} and \code{\link{fastclime}}
