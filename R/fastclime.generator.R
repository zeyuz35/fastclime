...
fastclime.generator = function(
  ...
  if (vis == TRUE) {
    ...
    graphics::image(theta, col = grDevices::gray.colors(256), main = "Adjacency Matrix")
...
plot.sim <- function(x, ...) {
  ...
  on.exit(graphics::par(old_par), add = TRUE)
  graphics::image(as.matrix(x$theta), col = grDevices::gray.colors(256), main = "Adjacency Matrix")
  graphics::image(x$sigma, col = grDevices::gray.colors(256), main = "Covariance Matrix")
