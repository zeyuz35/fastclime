...
#' Print a simulated data object
#'
#' Prints information about a \code{sim} object.
#'
#' @param x An object of class \code{sim}.
#' @param ... Additional arguments for generic print.
#' @method print sim
#' @export
...
#' Plot a simulated data object
#'
#' Plots the true graph structure and covariance matrix of a \code{sim} object.
#'
#' @param x An object of class \code{sim}.
