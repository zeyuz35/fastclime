...
fastclime.generator = function(
  ...
  # Optimize redundant solve(): Sigma_new = D^{-1/2} Sigma_old D^{-1/2}
  # Inverse: Omega_new = D^{1/2} Omega_old D^{1/2}
  Sigma_old = solve(omega)
  sigma = cov2cor(Sigma_old)
  D_sqrt = sqrt(diag(Sigma_old))
