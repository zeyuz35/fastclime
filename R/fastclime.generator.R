...
#'
#' Prints a summary of the simulated data generated by the package.
#' It outputs the sample size, dimension, graph type, and sparsity level.
#'
#' @param x An object of class \code{sim} generated by \code{fastclime.generator}.
...
#' Plot Simulated Data
#'
#' Plots the true adjacency, covariance, and empirical covariance matrices.
#' It also visualizes the graph pattern using a layout.
#'
#' @param x An object of class \code{sim} generated by \code{fastclime.generator}.
#' @param ... Additional arguments for generic methods.
#' @method plot sim
