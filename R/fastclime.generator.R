...
fastclime.generator = function(
  ...
  sigma = cov2cor(omega_inv)
  D_sqrt = sqrt(diag(omega_inv))
  # OPTIMIZATION: Mathematically derive the precision matrix using matrix-vector
  # scaling (D_sqrt * omega * D_sqrt) to avoid an expensive O(n^3) solve(sigma) inversion.
