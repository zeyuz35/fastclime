...
#'
#' @details
#' This program uses parametric simplex linear programming method to solve CLIME (Constrained \eqn{\ell_1} Minimization Sparse Precision Matrix Estimation) problem.
#' The solution path of the problem corresponds to the parameter in the parametric simplex method.
...
#' \item{sigmahat}{The empirical covariance of the data. If \code{cov.input} is \code{TRUE}, \code{sigmahat} = \code{data}.}
...
#' \item{lambdamtx}{The sequence of regularization parameters for each column, it is a \code{nlambda} by \code{d} matrix. It will be filled with \code{0} when the program finds the required \code{lambda.min} value for that column. This parameter is required for \code{\link{fastclime.selector}}.}
