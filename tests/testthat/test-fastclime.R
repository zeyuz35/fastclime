...
test_that("fastclime and fastclime.selector work", {
  ...
  expected_diag2 <- c(0.762140702950449, 0.633779711137966, 0.937068217957607, 0.76679258609295,
  0.753129358545887, 0.780585681825069, 0.90351248805164, 0.703319735490884,
  1.02759905622002, 0.626497647383406, 0.689806635829378, 0.573982636146926,
  0.885660885280414, 0.631914497389653, 0.716117164901718, 0.880511601587492,
  0.825161440483817, 0.666552990009741, 0.589422150397827, 0.789564293658653
  )
  expect_equal(
  ...
  expected_diag3 <- c(0.914040442848457, 0.655794975850777, 1.01026137949494, 0.829814761275012,
  0.814611574235182, 0.835437244092799, 1.08993087897186, 0.885894248340138,
  1.07112270097721, 0.676717629655321, 0.827665490929518, 0.620924851937563,
  0.902722137034022, 0.687954314936285, 0.925435052860397, 0.948637329358935,
  0.842620293349863, 0.757594936506894, 0.719807891492106, 0.863831605667571
  )
  expect_equal(
